...
//BROKEN_WINDOW  Add and Remove review like could be modularised fr
...
func AddReviewLike(w http.ResponseWriter, r *http.Request) {
	...
	err, code := models.SetReviewLike(userId, reviewId, true)
...
func RemoveReviewLike(w http.ResponseWriter, r *http.Request) {
	...
	err, code := models.SetReviewLike(userId, reviewId, false)
